#Cluster_Cds
A aplicação tem por objetivo permitir que agentes de diferentes Roles tenham acesso a diferentes recursos e dashboard. Onde um usuário comum pode manter (cadastrar, ler, editar e deletar) os CD 's cadastrados somente por ele mesmo, porém, visualizar todos, enquanto que o
agente Administrador tem autorização para manter o sistema como um todo. 
